            ...
            <div className="auth-box" style={{ maxWidth: '600px', marginTop: '50px' }}>
              {isLogin ? (
                <>
                  ...
                  >
                    Ren<span style={{ color: '#ffc107' }}>t</span> Paym<span style={{ color: '#ffc107' }}>ent</span> <span style={{ color: '#ffc107' }}>Man</span>agement <span style={{ color: '#ffc107' }}>Sys</span>tem
                  </h1>
                  <form
